...
window.openEdit = (uid) => {
  ...
  const radioPeruntukan = document.querySelectorAll('input[name="edit-unit"]');
  radioPeruntukan.forEach((r) => {
    // Pastikan perbandingan konsisten dengan nilai yang dikembalikan API backend
